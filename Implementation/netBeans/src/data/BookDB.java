...
public class BookDB {
    ...
    // TODO: 2016-03-16 finish this method
//    public static int insertBook(Book book)
//            throws SQLException {
//        ConnectionPool connectionPool = ConnectionPool.getInstance();
//
//        String query = "INSERT INTO book (isbn_13, title, pub_year, description, image, thumb) " +
//                "VALUES (?, ?, ?, ?, ?, ?)";
//
//        try (Connection connection = connectionPool.getConnection()) {
...
//                preparedStatement.setString(6, book.getThumbnail());
...
//    }
    ...
    public static List<Book> selectBookCategoryList(String category)
            throws SQLException {
        ConnectionPool connectionPool = ConnectionPool.getInstance();
